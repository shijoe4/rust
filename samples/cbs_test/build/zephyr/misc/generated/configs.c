...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG_JOB_PUSH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG_JOB_COMPLETE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG_BUDGET_CONDITION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG_BUDGET_RAN_OUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG_SWITCHED_IN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_LOG_SWITCHED_OUT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_THREAD_STACK_SIZE, 2048);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_QUEUE_LENGTH, 16);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_INITIAL_DELAY, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CBS_THREAD_MAX_NAME_LEN, 20);
